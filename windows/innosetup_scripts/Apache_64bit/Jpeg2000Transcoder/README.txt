Add JPEG2000Transcoder files here (should be built in MSVC2008 for better compatibility):
...
msvcp90.dll, msvcr90.dll (32bit version unless you built 64bit)
In Moravian Library installer, we have built only 32bit Transcoder.
...
binaries for 32bit version, for 64bit it takes it from this fodler.