; INSTALLER for IIPIMAGE JPEG2000 x86 with Kakadu and Memcached
...
OutputBaseFilename=IIPImage_IIS_x86
...
Source: "Program Files\msvcp100.dll"; DestDir: "{code:GetTranscoderDir}\Jpeg2000Transcoder"
Source: "Program Files\msvcr100.dll"; DestDir: "{code:GetTranscoderDir}\Jpeg2000Transcoder"
...
begin
  ...
  // 3. param - path to system drive (used for "hack" for installation on 64bit)
...
begin
  ...
  // if pkgmgr does not exist, exit installation, we can't install IIS without it
