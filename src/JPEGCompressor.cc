...
void JPEGCompressor::InitCompression( const RawTile& rawtile, unsigned int strip_height, unsigned char *iccProfile, long iccProfileSize ) throw (string)
{
  ...
  write_icc_profile(&cinfo, iccProfile, iccProfileSize);
